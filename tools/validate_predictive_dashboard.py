...
def main() -> None:
    ...
    required = (
        ...
        "select.pylontech_h3x_predictive_dispatch_grid_connection_rating",
        "sensor.pylontech_h3x_predictive_dispatch_grid_connection_capacity",
        "select.pylontech_h3x_predictive_dispatch_battery_circuit_rating",
        "sensor.pylontech_h3x_predictive_dispatch_battery_circuit_capacity",
        "number.pylontech_h3x_predictive_dispatch_battery_circuit_limit",
        ...
        "attribute: source_last_reported",
        "attribute: source_age_seconds",
        "attribute: autodetected_candidates",
        "attribute: candidate_states",
        "attribute: active_profile_description",
        "Strategy profile guide",
        "Configure Shelly grid source",
        "/config/integrations/integration/h3x_predictive_dispatch",
